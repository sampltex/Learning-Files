...
button1 = Button(root, text="1", padx=40, pady=20, command=lambda: buttonclick(1)) # you need to use a lambda since you cant actually input arguments in tkinter
...
buttonequal = Button(root, text="=", padx=89, pady=20, command=button_equal)
buttonclear = Button(root, text="Clear", padx=79, pady=20, command=button_clear) # you only need the lambda if you want to pass something into it

buttonsubtract = Button(root, text="-", padx=41, pady=20, command=button_sub)
buttonmultiply = Button(root, text="*", padx=41, pady=20, command=button_multi)
buttonadivide = Button(root, text="/", padx=41, pady=20, command=button_div)
...
buttonadivide.grid(row=6, column=2)
